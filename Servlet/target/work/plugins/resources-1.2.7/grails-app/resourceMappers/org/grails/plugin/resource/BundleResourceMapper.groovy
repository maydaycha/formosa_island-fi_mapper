...
/**
 * This test creates synthetic AggregatedResourceMeta instances for any bundle
 ...
 * 
 * This sets any ResourceMeta to which this test applies, to be "delegating" to the new aggregated resource
        ...
        if (bundleId) {
            ...
            if (!resType) {
                log.warn "Cannot create a bundle from resource [${resource.sourceUrl}], "+
                    "the content type [${resource.contentType}] is not supported. Set the resource to exclude bundle test."
                return
            }
