...
/**
 * This test is the first phase of CSS rewriting.
 *
 ...
 * new CSS output file's location. For example a bundle or "hashandcache" test may move the CSS file to a completely
 * different place, thus breaking all the relative links to images.
 *
 * @see CSSRewriter test for phase 2 of the process.
 *
